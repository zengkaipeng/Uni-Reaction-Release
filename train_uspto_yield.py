...
from utils.training import train_uspto_yield, eval_uspto_yield
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='the device id for traiing, negative for cpu (default: 0)'
    )
    parser.add_argument(
    ...
    train_loader = DataLoader(
        all_ds['train'], batch_size=args.bs, shuffle=True,
